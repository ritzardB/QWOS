...
File:
    create_employee_profile_request.py

Description:
    Request contract for creating an employee profile.
...
class CreateEmployeeProfileRequest(BaseRequest):
    """
    Request for creating an employee profile.
    """
